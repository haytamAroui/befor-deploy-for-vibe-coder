...
APPROVED_IMPLEMENTATION_IDS = frozenset(
    {
        "SEC-API-001",
        "SEC-API-ASSURANCE-FASTAPI-001",
        "SEC-API-AUTHZ-001",
        "SEC-API-INPUT-001",
        "SEC-API-UPLOAD-001",
        "SEC-AUTH-FASTAPI-001",
        "SEC-CICD-001",
        "SEC-CONFIG-001",
        "SEC-CONFIG-002",
        "SEC-COMPOSE-PRIVILEGED-001",
        "SEC-DATABASE-TRANSPORT-PYTHON-001",
        "SEC-DATA-INTEGRITY-001",
        "SEC-DEP-001",
        "SEC-DEP-VULN-001",
        "SEC-ENDPOINT-FASTAPI-001",
        "SEC-ERROR-HANDLING-PYTHON-001",
        "SEC-FASTAPI-COMMAND-INJECTION-001",
        "SEC-FASTAPI-SESSION-COOKIE-001",
        "SEC-FASTAPI-SSRF-001",
        "SEC-FASTAPI-SSRF-ALIAS-001",
        "SEC-GO-MODULE-001",
        "SEC-GO-TLS-001",
        "SEC-GO-VULN-001",
        "SEC-GOSEC-001",
        ...
        "SEC-OBSERVABILITY-PYTHON-001",
        "SEC-PAYMENT-STRIPE-WEBHOOK-001",
        ...
        "SEC-SECURITY-TESTING-EVIDENCE-001",
        "SEC-SENSITIVE-DATA-PYTHON-001",
        "SEC-SPRING-ACTUATOR-001",
        "SEC-SPRING-CORS-001",
        "SEC-SPRING-JPA-NATIVE-QUERY-001",
