...
| 8 | Completed Ruby/Rails ecosystem increment: one conventional direct Gemfile lockfile-presence control. | Separate `SEC-RUBY-RAILS-GEMFILE-LOCK-001` implementation, opt-in policy, contract, secure/vulnerable/indented/error fixtures, and no Ruby/Bundler/Rails execution. | Generic Ruby coverage, Gemfile value/lock parsing, integrity, vulnerability, dependency-resolution, dynamic declarations, groups, libraries, nested projects, configuration, or runtime claims remain excluded. |
| 9 | Completed Docker Compose infrastructure increment: one direct privileged-service configuration control. | Separate `SEC-COMPOSE-PRIVILEGED-001` implementation, opt-in policy, contract, secure/vulnerable/dynamic-or-aliased/invalid fixtures, and no Docker/Compose execution. | Other Compose configuration, dynamic/reused YAML, containers, images, capabilities, host policy, runtime privilege, Kubernetes, Helm, CloudFormation, Terraform, or deployment claims remain excluded. |
...
[8]: https://guides.rubygems.org/dependency_management/ "RubyGems Guides — How to manage dependencies with Bundler"
[9]: https://guides.rubyonrails.org/configuring.html "Rails Guides — Configuring Rails Applications"
[10]: https://docs.docker.com/reference/compose-file/ "Docker Docs — Compose file reference"
[11]: https://docs.docker.com/reference/compose-file/services/ "Docker Docs — Define services in Docker Compose"
