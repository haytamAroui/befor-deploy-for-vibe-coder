...
The catalog maps **only the twenty-four reviewed capability implementations already registered**. It adds no scanner and cannot make an unconfigured adapter run.
